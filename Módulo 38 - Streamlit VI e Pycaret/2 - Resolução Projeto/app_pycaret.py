...
def main():
    ...
    if (data_file_1 is not None):
        ...
        model_saved = load_model(r'C:\Users\Guilherme Rhein\Downloads\Streamlit VI e Pycaret\Exercícios\2 - Resolução Projeto\2 - Resolução Projeto\final_lightgbm.pkl')
